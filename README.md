...
└── app/
    └── Main.java
Responsabilidad de paquetes
Paquete	Responsabilidad
modelo	Clases del negocio
servicio	CRUD y lógica
util	Validaciones
app	Menú principal
UML del sistema
...
Este proyecto permite aplicar conceptos fundamentales de Java y Programación Orientada a Objetos como:
